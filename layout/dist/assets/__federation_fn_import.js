...
const moduleMap= {'vue':{get:()=>()=>__federation_import('./__federation_shared_vue.js'),import:true},'pinia':{get:()=>()=>__federation_import('./__federation_shared_pinia.js'),import:true}};
